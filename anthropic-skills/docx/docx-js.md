...
**IMPORTANT: Use Aptos as the default font** - Aptos is Microsoft's new default font for Word (replacing Calibri). Use 12pt (size: 24) for body text.

**Word Standard Heading Sizes (match Word's built-in styles):**
- **Title**: 28pt (size: 56), Aptos Display (not bold)
- **Heading 1**: 16pt (size: 32), Aptos Display, color #2F5496 (Word's default blue), not bold
- **Heading 2**: 13pt (size: 26), Aptos Display, color #2F5496, not bold
- **Heading 3**: 12pt (size: 24), Aptos Display, color #2F5496, not bold
- **Body**: 12pt (size: 24), Aptos

```javascript
const doc = new Document({
  styles: {
    default: { document: { run: { font: "Aptos", size: 24 } } }, // 12pt Aptos default
    paragraphStyles: [
      // Document title style - matches Word's built-in Title
      { id: "Title", name: "Title", basedOn: "Normal",
        run: { size: 56, color: "000000", font: "Aptos Display" }, // 28pt, NOT bold
        paragraph: { spacing: { before: 0, after: 60 }, alignment: AlignmentType.LEFT } },
      // IMPORTANT: Override built-in heading styles to match Word defaults - NOT bold
      { id: "Heading1", name: "Heading 1", basedOn: "Normal", next: "Normal", quickFormat: true,
        run: { size: 32, color: "2F5496", font: "Aptos Display" }, // 16pt, Word blue, NOT bold
        paragraph: { spacing: { before: 240, after: 0 }, outlineLevel: 0 } }, // Required for TOC
      { id: "Heading2", name: "Heading 2", basedOn: "Normal", next: "Normal", quickFormat: true,
        run: { size: 26, color: "2F5496", font: "Aptos Display" }, // 13pt, Word blue, NOT bold
        paragraph: { spacing: { before: 160, after: 0 }, outlineLevel: 1 } },
      { id: "Heading3", name: "Heading 3", basedOn: "Normal", next: "Normal", quickFormat: true,
        run: { size: 24, color: "2F5496", font: "Aptos Display" }, // 12pt, Word blue, NOT bold
        paragraph: { spacing: { before: 160, after: 0 }, outlineLevel: 2 } },
...
- **Use Aptos font** - Microsoft's default font for Word. Use "Aptos Display" for titles/headings, "Aptos" for body text
- **Use 12pt body text** (size: 24 in DXA) - this is Word's standard
- **Headings should NOT be bold** - Word's default Aptos headings use color and size for hierarchy, not bold
- **Match Word's heading colors** - use #2F5496 (Word's default blue) for headings to match the standard Word look
...
- **ALWAYS use Aptos font** - Microsoft's default font for Word. Use "Aptos Display" for titles/headings, "Aptos" for body text
- **ALWAYS use 12pt (size: 24) for body text** - this is Word's standard
- **ALWAYS use Word's heading colors** - #2F5496 for headings to match Word's default look
- **NEVER make headings bold** - Word's default Aptos headings use color and size for hierarchy, not bold
- **ALWAYS set a default font** using `styles.default.document.run.font` - Aptos recommended
