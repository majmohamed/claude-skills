...
- For Work IQ queries, use the current date from system context to calculate the exact date range. Do NOT rely on relative terms alone - specify "from YYYY-MM-DD to YYYY-MM-DD" in every Work IQ query
